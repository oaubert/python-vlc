...
enum libvlc_enum_no_values_specified {
    G,
    H,
    I
};

enum libvlc_enum_all_values_specified {
    J = 2,
    K = 4,
    L = 6
};
...
enum libvlc_enum_with_hex_values {
    U = 0x1,
    V = 0xf
};

enum libvlc_enum_with_bit_shifted_values {
    W = 'r' << 16,
    X = 'g' << 16
};
...
// Typedef enums
// ============================================================================
typedef enum not_from_libvlc_enum_t {
    AA,
    BB,
    CC
} not_from_libvlc_enum_t;
